...
export default function Hero() {
  ...
  return (
    <section className={styles.hero}>
      ...
      <img src="/visa-header.png" alt="Visa" className={styles.heroVisa} />
        ...
        <div className={styles.textContent}>
          ...
          <div className={styles.descBox}>
            <p className={styles.subtitle}>
              Фотти оживит ваши фотографии или аккуратно отредактирует снимки по вашему желанию. Просто отправьте фотографии и опишите результат - обработку, подбор движения и финальную сборку мы возьмём на себя.
            </p>
          </div>
