...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      price: "1 190₽",
      description: [
        "Подходит как для простых, так и для сложных задач",
        "Объединим до 5 фотографий в одну реалистичную композицию",
        "Полностью изменим стиль, фон и атмосферу фотографии",
        "Добавим или удалим любые объекты",
        "Улучшим качество и детализацию фотографии",
        "Базовая цена включает 2 фотографии. Каждая следующая — +200₽"
      ],
